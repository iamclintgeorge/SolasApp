...
import '../content/creeds/athanasian_content.dart'; // Update with your actual file path

class AthanasianScreen extends StatelessWidget {
  const AthanasianScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // final metadata = apostlesContent['Metadata'] as Map<String, dynamic>;
    final content =
        (athanasianContent['Data'] as Map<String, dynamic>)['Content']
            as String;
